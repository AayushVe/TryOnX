...
function SignUp() {
  ...
  const handleSignUp = (e: React.FormEvent) => {
    ...
    // On successful sign-up, navigate to home
    navigate('/home');
  };
      ...
      >
        <GlassPanel className="p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 font-light">Join the future of fashion.</p>
          </div>
          ...
          <div className="text-center mt-6">
            <p className="text-sm text-gray-400 font-light">
              ...
              <button onClick={() => navigate('/signin')} className="font-medium text-indigo-400 hover:text-indigo-300 transition-colors">
                Sign In
              </button>
            </p>
          </div>
