    ...
    <div className="flex w-full h-screen">
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center bg-white p-8">
        <div className="w-full max-w-sm">
          ...
          <p className="text-center text-gray-600 mb-8">Start your fashion journey</p>
          ...
          <p className="text-center text-sm text-gray-600 mt-8">
            ...
            <button onClick={() => navigate('/signin')} className="font-medium text-purple-600 hover:text-purple-500">
              Sign in
            </button>
          </p>
        </div>
